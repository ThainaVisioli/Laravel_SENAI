        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  <div class="col-md-12">
                  <div class="card">
                    <h5 class="card-header text-center">Listagem de Nivel de Acesso ⬆️</h5>
                    <div class="card-body">
                        <div class="card">
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              ...
                              >
                          <a class="dropdown-item" href="javascript:void(0);" onclick="deletarItem(this)">
